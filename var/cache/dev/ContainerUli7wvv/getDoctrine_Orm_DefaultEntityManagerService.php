...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\ClientRepository' => function () {
    return ${($_ = isset($this->services['App\Repository\ClientRepository']) ? $this->services['App\Repository\ClientRepository'] : $this->load('getClientRepositoryService.php')) && false ?: '_'};
}, 'App\\Repository\\GeocodingRepository' => function () {
    return ${($_ = isset($this->services['App\Repository\GeocodingRepository']) ? $this->services['App\Repository\GeocodingRepository'] : $this->load('getGeocodingRepositoryService.php')) && false ?: '_'};
}, 'App\\Repository\\ImportRepository' => function () {
    return ${($_ = isset($this->services['App\Repository\ImportRepository']) ? $this->services['App\Repository\ImportRepository'] : $this->load('getImportRepositoryService.php')) && false ?: '_'};
}))));
