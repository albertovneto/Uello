...
return $this->services['App\Repository\ClientRepository'] = new \App\Repository\ClientRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
