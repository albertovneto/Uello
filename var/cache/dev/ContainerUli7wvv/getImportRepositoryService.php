...
// Returns the private 'App\Repository\ImportRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ImportRepository.php';

return $this->services['App\Repository\ImportRepository'] = new \App\Repository\ImportRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
